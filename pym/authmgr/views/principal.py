...
class PrincipalView(object):
    ...
    def _build_browse_queries(self, request, grid):
        sess = DbSession()
        vw_browse = pym.authmgr.models.get_vw_principal_browse()
    ...
    def __init__(self, context, request):
        ...
        self.DD['email']['validator'] = pym.lib.EmailValidator()
    ...
    @view_config(
        name='',
        renderer='pym:authmgr/templates/principal/index.mako',
    )
    def index(self):
        ...
        for r in rs:
            name = r[1]
            roles.append((r[0], name))
        roles.sort(key=lambda it: it[1])
    ...
    def xhr_browse(self):
        ...
        # build_browse_queries() gets an uninitialised grid and sets defaults
