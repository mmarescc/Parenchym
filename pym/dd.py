...
def fully_qualify(*dds):
    ...
    :attr:`pym.models.DefaultMixinDd` has the fields
    ...
    alias of :class:`pym.authmgr.Principal` with the name ``owner`` and
...
###    :param prefix: String to prefix the keys (field names) of the mixins
###        with.
