<%!
    from pym.res.const import NODE_SYS
    from pym.auth.const import (NODE_SYS_AUTH_MGR, NODE_SYS_AUTH_USER_MGR,
        NODE_SYS_AUTH_GROUP_MGR, NODE_SYS_AUTH_GROUP_MEMBER_MGR,
        NODE_SYS_AUTH_PERMISSION_MGR)
%>
<%
    node_sys = request.root[NODE_SYS]
        ...
        <ul>
          <li><a href="${url_to(node_auth)}">Authentication Manager</a>
            <ul>
              ...
              <li><a href="${url_to(node_auth[NODE_SYS_AUTH_GROUP_MEMBER_MGR])}">Manage Group Members</a>
              </li>
